    ...
    <div style={{ minHeight: '100vh', background: '#f8faff', fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      <div style={{ background: 'linear-gradient(135deg, #4f46e5, #7c3aed)', padding: '48px 64px', color: 'white' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <h1 style={{ fontSize: 36, fontWeight: 800, margin: 0 }}>My Applications</h1>
      ...
      <div style={{ maxWidth: 1200, margin: '48px auto', padding: '0 64px' }}>
        {loading ? (
          ...
          <div style={{ textAlign: 'center', padding: '80px 0' }}>
            ...
            <p style={{ color: '#d1d5db', fontSize: 14 }}>Browse internships and start applying.</p>
            <button
          ...
          <div style={{ background: 'white', borderRadius: 24, overflow: 'hidden', boxShadow: '0 4px 24px rgba(0,0,0,0.06)', border: '1px solid #f1f5f9' }}>
            {/* Header row */}
            <div style={{ display: 'grid', gridTemplateColumns: '2fr 2fr 1fr 1fr', padding: '16px 28px', background: '#f8faff', borderBottom: '1px solid #f1f5f9' }}>
              {['Internship', 'Company', 'Applied', 'Status'].map(h => (
            ...
            {applications.map((app, i) => (
              ...
              >
                <div style={{ fontSize: 14, fontWeight: 600, color: '#111827' }}>{app.listingTitle}</div>
                <div style={{ fontSize: 14, color: '#374151' }}>{app.companyName}</div>
